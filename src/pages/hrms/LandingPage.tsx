    ...
    <div className="min-h-screen bg-slate-50 p-3 md:p-6 animate-in fade-in duration-500">
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           ...
           <div className="lg:col-span-3 space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                 ...
                 <div className="grid grid-cols-2 gap-3">
                    <button className="p-4 bg-slate-50 rounded-xl border border-slate-100 flex flex-col items-center gap-2 group hover:border-red-400 transition-all">
           ...
           {/* Live Preview Area */}
           <div className="lg:col-span-9 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden relative min-h-[600px] group">
              {/* Browser bar */}
              ...
              <div className="p-12 text-center space-y-10">
                 ...
                 <div className="flex items-center justify-center gap-4">
                    <button className="px-8 py-4 bg-slate-900 text-white rounded-xl font-black flex items-center gap-3 group/btn">
                       Explore Roles
                       <ArrowRight size={18} className="group-hover/btn:translate-x-1 transition-transform" />
                    </button>
                    <button className="px-8 py-4 border-2 border-slate-100 text-slate-900 rounded-xl font-black hover:bg-slate-50 transition-all">
                       Our Culture
                    </button>
                 </div>
              ...
              <div className="absolute inset-0 bg-red-400/5 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none flex items-center justify-center border-4 border-red-400/20 m-4 rounded-xl">
...
function StructureItem({ label, active = false }: { label: string, active?: boolean }) {
   return (
      <div className={`p-4 rounded-xl border transition-all flex items-center justify-between group cursor-pointer ${active ? 'bg-red-50 border-red-100' : 'bg-slate-50 border-slate-100 hover:bg-white hover:border-slate-200'}`}>
         <div className="flex items-center gap-3">
