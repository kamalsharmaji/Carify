        ...
        <div className="hidden lg:flex flex-col justify-between p-12 bg-[#0f172a] text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl font-black leading-[1.1] mb-6 tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-red-600 text-6xl">Intelligence.</span>
            </h1>
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 p-4 bg-white/5 rounded-[24px] border border-white/10 backdrop-blur-xl max-w-fit shadow-2xl">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-0.5">System Security</p>
                <p className="text-[13px] font-bold">256-bit AES Encryption Active</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white">
          <div className="max-w-sm mx-auto w-full">
            ...
            <div className="mb-10 text-center lg:text-left">
              ...
              <p className="text-slate-500 text-[14px] font-medium">Enter your credentials to access the console</p>
            </div>

            <form onSubmit={handleLogin} className="space-y-5">
              <div className="space-y-4">
                <div className="space-y-1.5">
                  <label className="text-[11px] font-black text-slate-400 uppercase tracking-[0.15em] ml-1">Email</label>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center ml-1">
                    ...
                    <button type="button" className="text-[11px] font-bold text-red-500 uppercase tracking-wider hover:text-red-600 transition-colors">Forgot?</button>
                  </div>
                  <div className="relative group">
              ...
              <div className="flex items-center gap-2.5 ml-1">
                <input 
                  type="checkbox" 
                  id="remember" 
                  className="w-4.5 h-4.5 rounded-md border-slate-200 text-red-500 focus:ring-red-500/20 cursor-pointer transition-all" 
                />
                <label htmlFor="remember" className="text-[13px] font-semibold text-slate-500 cursor-pointer select-none">Remember this device</label>
              </div>

              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-red-500 hover:bg-slate-800 text-white py-4 rounded-2xl font-black text-[15px] transition-all shadow-xl shadow-slate-200 flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed active:scale-[0.98] mt-2"
              >
                {isLoading ? (
