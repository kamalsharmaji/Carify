    ...
    <div className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-10 animate-in fade-in duration-700">
      <div className="max-w-[1600px] mx-auto space-y-6">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-3xl font-black text-slate-900 tracking-tight">
                    Vendor <span className="text-red-600">Performance</span>
                  </h1>
                </div>
                <p className="text-slate-500 mt-1 font-semibold text-sm">
                  VMS › Rate and review your vendor service levels
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-12 shadow-sm min-h-[400px] flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-xl font-black text-slate-900">No Performance Data</h3>
          <p className="text-slate-500 mt-2 font-semibold text-sm">Vendor evaluations will appear here</p>
        </div>
      </div>
    </div>
  );
