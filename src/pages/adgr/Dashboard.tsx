    ...
    <div className="min-h-screen bg-[#F1F5F9] p-4 sm:p-6 lg:p-10 animate-in fade-in duration-700">
      <div className="max-w-[1600px] mx-auto space-y-10">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
                    ADGR <span className="text-red-600">Dashboard</span>
                  </h1>
                </div>
                <p className="text-slate-500 mt-2 font-semibold text-lg">
                  Automated Data Generation & Reporting Control Center
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            { label: "Reports Generated", value: "2,540", icon: FileText, color: "blue" },
            { label: "Data Volume", value: "4.2 TB", icon: Archive, color: "emerald" },
            { label: "Active Jobs", value: "18", icon: BarChart3, color: "rose" },
            { label: "Success Rate", value: "99.9%", icon: LayoutDashboard, color: "blue" },
          ].map((stat, i) => (
        ...
        <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-[40px] p-8 shadow-2xl shadow-slate-200/50 min-h-[400px] flex flex-col items-center justify-center text-center">
          ...
          <p className="text-slate-500 mt-2 font-semibold">ADGR engine is online and monitoring data streams</p>
        </div>
      </div>
    </div>
  );
