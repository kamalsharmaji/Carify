      ...
      <div className="h-16 flex items-center justify-between px-3 sm:px-4 md:px-6">
        ...
        <div className="flex items-center gap-3 relative">
          ...
          <div className="relative">
            ...
            >
              <div className="h-8 w-8 rounded-full bg-red-600 text-white flex items-center justify-center text-sm font-bold">
                CA
              </div>
              <ChevronDown size={14} />
            </button>
            ...
            {activeDropdown === "user" && (
              <div className="absolute right-0 mt-2 w-44 bg-white border rounded-xl shadow-xl overflow-hidden">
                ...
                <button
                  onClick={handleLogout}
                  className="w-full px-4 py-2 text-sm hover:bg-red-50 text-red-600 flex items-center gap-2"
                >
